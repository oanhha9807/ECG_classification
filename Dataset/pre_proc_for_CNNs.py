...
save_dir = '/data/oanh/Bio/Images_9_new_data/'
X_for_CNNs(path, partition='train', save_dir=save_dir)
X_for_CNNs(path, partition='test', save_dir=save_dir)
print('Done to create images')