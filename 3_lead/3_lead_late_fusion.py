...
from utils import configure_seed, configure_device, compute_scores, Dataset_for_RNN_new, \
...
class RNN_att(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_layers, n_classes, dropout_rate, bidirectional, gpu_id=None):
        ...
        self.attention1 = Attention(192, batch_first=True)
...
def main():
    ...
    for ii in epochs:
        ...
        save_results_to_txt(ii, f1,max_acc, matrix, 'combination_2_model_late.txt')
    # plot
